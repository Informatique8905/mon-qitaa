...
interface StatCard { label: string; value: string; icon: React.ReactNode; color: string; trend: string; gradient: string; }
...
const STATS: StatCard[] = [
  { label: "Établissements Inscrits", value: "24", icon: <Users size={20} />, color: "text-orange-600", gradient: "from-orange-400 to-orange-600", trend: "+3 ce mois" },
  { label: "Candidats Validés", value: "312", icon: <Trophy size={20} />, color: "text-emerald-600", gradient: "from-emerald-400 to-emerald-600", trend: "+18 cette semaine" },
  { label: "Moyenne Générale", value: "14.7", icon: <Star size={20} />, color: "text-blue-600", gradient: "from-blue-400 to-blue-600", trend: "Épreuves en cours" },
  { label: "Scans QR Terminés", value: "87%", icon: <ScanLine size={20} />, color: "text-purple-600", gradient: "from-purple-400 to-purple-600", trend: "271 / 312 candidats" },
];
        ...
        <div className="flex-1 overflow-y-auto px-4 lg:px-8 py-6 space-y-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
              {STATS.map((stat, i) => (
                <div key={i} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 lg:p-5 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-default group">
